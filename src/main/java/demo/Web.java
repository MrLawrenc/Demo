...
public class Web {
    ...
    public static void main(String[] args) {
        Web webCrawlerDemo = new Web();
        for (int i = 0; i < 100000; i++) {
            new Thread(() -> webCrawlerDemo.myPrint("https://matrix.dean.swust.edu.cn/acadmicManager/index.cfm?event=studentPortal:DEFAULT_EVENT&ticket=ST-2431505-2JZPy4CfWiHrWS7JOJYe1534670181087-hrYf-cas")).start();
        }
